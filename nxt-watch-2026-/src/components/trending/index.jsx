...
const Trending = () => {
  ...
  const addToWatchLaterFolder = async (folderId, FolderName) => {
    try {
      const res = await axios.post(
        "http://localhost:5000/api/add-to-watch-later-folder",
        {
          folderId,
          movieId,
          MovieName,
        ...
        <div className="trending-page">
          ...
          <section className="movies-section">
            <div className="section-header">
              <h2 className="section-title">Loading amazing movies...</h2>
            </div>
          ...
          <section className="error-section">
            <div className="error-content">
              ...
              <p className="error-description">
                We couldn't load the trending movies. Please try again later.
              </p>
            </div>
          </section>
        </div>
          ...
          <div className="hero-content">
            ...
            <div className="hero-stats">
              <span className="stat-item">
                <strong>{animes.length}</strong> movies loaded
              </span>
            </div>
          </div>
        ...
        <section className="movies-section">
                      ...
                      <div className="menu-dropdown">
                        <button
                          ...
                          onClick={(e) => {
                            e.preventDefault();
                            e.stopPropagation();
                            renderWatchLaters(movie.id, movie.title);
                          }}
                        >
                          <MdPlaylistAddCircle />
          ...
          {isFetchingNextPage && (
            <div className="loading-more">
              <Loader type="ThreeDots" color="#6366f1" height="40" width="40" />
  ...
  return <div className="trending-container">{renderAnime()}</div>;
};
