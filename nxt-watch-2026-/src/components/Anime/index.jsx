...
const Anime = () => {
          ...
          <section className="anime-hero">
            <div className="hero-content">
              ...
              <p className="hero-subtitle">
                Discover amazing anime and animated movies
              </p>
            </div>
          </section>
          ...
          <section className="error-section">
            <div className="error-content">
              ...
              <p className="error-description">
                We couldn't load the anime. Please try again later.
              </p>
            </div>
          </section>
        </div>
          ...
          <div className="hero-content">
            ...
            <div className="hero-stats">
              <span className="stat-item">
                <strong>{animes.length}</strong> anime loaded
              </span>
            </div>
          </div>
            ...
            <div className="overlay-content">
              <div className="overlay-header">
                ...
                <p className="overlay-subtitle">
                  Choose a folder for this anime
                </p>
              </div>
        ...
        <section className="movies-section">
          <div className="section-header">
            ...
            <p className="section-description">
              Click on any anime to start watching
            </p>
          </div>
          ...
          {isFetchingNextPage && (
            <div className="loading-more">
              <Loader type="ThreeDots" color="#a78bfa" height="40" width="40" />
  ...
  return <div className="anime-container">{renderAnime()}</div>;
};
